...
These posts are an introduction to vectors for those comfortable with the nim programming language, and an introduction to the nim programming language for those who are comfortable witn vectors.
...
This post introduces the basics of the nim programming language and vectors needed for future development.
